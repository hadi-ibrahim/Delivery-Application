...
public class CustomerViewOrderItems extends JPanel {
	...
	private CustomerViewOrderItems self = this;
	 ...
	 * Create the frame.
	 */
	public CustomerViewOrderItems(JPanel mainPanel, Order order, String backPanelName ) {
		super();
